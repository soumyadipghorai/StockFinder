...
with col1 :
    ...
    company_name = st.selectbox(label = 'enter screener URL', options=[all_company[key]["name"] for key in all_company])
...
if btn :
    ...
    company_code = next(key for key, value in all_company.items() if value["name"] == company_name) 
